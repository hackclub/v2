      ...
      <Box bg="dark" align="center" pt={[4, 5]}>
        <Container maxWidth={72} px={3} py={[5, 6]}>
          ...
          >
            ...
            clubs. We make together, learn together, organize hackathons
            together. This is your home.
          </Lead>
        </Container>
      </Box>
      <Box bg="darker" py={4}>
        <Container px={3} pt={5}>
          ...
          <Text color="smoke" fontSize={4} mb={3} style={{ maxWidth: '48rem' }}>
            ...
            to talk to. We’re artists, writers, engineers, tinkerers, campers,
        ...
        <Quote mt={4}>
          <FirstLetter>
            I discovered Hack Club by accident last year when browsing on
            GitHub, and it is no doubt one of{' '}
          ...
          <Text>
            I could have never envisioned how much influence this community
            would have on my life a year ago. There are definitely many, many
            more lives around the globe to be changed like it has to mine.
          </Text>
      ...
      <Box bg={theme.colors.dark} py={[5, 6]}>
        <Container px={3}>
          ...
          <Text color="smoke" fontSize={4} mb={4} style={{ maxWidth: '48rem' }}>
            ...
            about running coding clubs and student events. We’re deeply
            committed to improving the high school hacking community, and are
            constantly launching new services to help.
          </Text>
          <Features mt={[4, 5]}>
            <Box>
              <ResourcesLine />
              ...
              <Text color="muted" fontSize={4}>
                ...
                sponsorship for high school events, and we’ll help you every
                step of the way.
              </Text>
            </Box>
            <Box>
      ...
      >
        <Container px={3} py={[5, 6]}>
          ...
          >
            ...
            together for Hack Night. It’s a remote hackathon, social hangout,
            and a ton of fun. Build, learn, and share together.
          </Text>
