  ...
  <ThemeProvider>
    ...
    <Base py={[4, 5]} px={3}>
      ...
      <Bio
        ...
        role="Web Designer"
        text="Lachlan, a club leader from State College, PA, joined the team to work on Hack Club’s website. He cares about bringing coding to more people and creating tools to make information more accessible."
        bg="blue"
      />
      <Bio
